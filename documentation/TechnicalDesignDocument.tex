...
\begin{document}
    ...
    The joint will decide whether another maramafication/instance will fit on this model.

    When the user tries to build a marama (a combination of maramafications) the user will always try to fit instances together.
    ...
    When two maramafications are connected, two
